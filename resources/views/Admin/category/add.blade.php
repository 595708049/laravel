...
<link href="{{ asset('js/admin/static/h-ui.admin/css/H-ui.admin.css') }}" rel="stylesheet" type="text/css" />
<!-- <link href="{{ asset('js/admin/lib/icheck/icheck.css') }}" rel="stylesheet" type="text/css" /> -->
